...
im = Image.open("C:/Users/Mcastiblanco/Documents/AGPC/DataScience2020/Streamlit/Mtto/mtto2.png")
...
with row1_1:
    image = Image.open('C:/Users/Mcastiblanco/Documents/AGPC/DataScience2020/Streamlit/Mtto/mttoch.jpg')
...
if path=='':
    ...
    for file in files:
        ...
        df=pd.read_excel(path+file)#, sep=';')#,encoding='latin-1',sep=';')#,encoding='ISO-8859-1')
